    ...
    <div class="participant-container">
        ...
        @if($participant)
            <div class="participant-card-bg"
                style="background-image: url('https://drive.google.com/uc?export=view&id={{ $participant->drive_image_file_id }}');">
                <div class="participant-overlay">
                    ...
                    <div class="participant-button-wrapper">
                        <button class="participant-btn-outline" data-bs-toggle="modal"
                            data-bs-target="#participantMediaModal">View Media</button>
                    </div>
                </div>
            </div>
